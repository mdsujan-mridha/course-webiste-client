...
const Join = () => {
    return (
        <>
            <div className="w-full h-auto py-2 lg:py-6 bg-transparent lg:px-24 flex lg:justify-between lg:items-center relative flex-col-reverse lg:flex-row">
            <div className='w-96 h-56  blur-3xl  absolute top-auto  left-0 right-auto bottom-16 opacity-20 skew-y-12 bg-orange-600' style={{ zIndex: 10 }}></div>
                <div className='px-5 lg:pl-20 w-full lg:w-1/2 flex flex-col'>
                ...
                <div className='w-full lg:w-1/3'> <img src={physics} alt="Physics" className='w-full vector-graphics' /> </div>
            </div>
        </>
    );
};
