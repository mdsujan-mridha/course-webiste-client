    ...
    return (
        <>
            <div className='my-24 relative'>
                ...
                <div className="flex flex-col lg:flex-row gap-5 lg:gap-24 bg-secondary w-96 lg:w-10/12 h-auto rounded-xl hover:shadow-2xl px-12" style={{ margin: '0 auto' }}>
                    <div className='flex items-center justify-center py-5'>
                        <img src={couseImg} alt="" className='rounded-xl' />
                    </div>
                    <div className='pt-5 relative'>
                        <h1 className='text-2xl lg:text-5xl font-bold'> Complete Physics Advance course with Sujan Mridha </h1>
                        <div className='bottom-5 lg:absolute flex lg:items-center gap-5 flex-col lg:flex-row pt-5 lg:mt-0 pb-5 lg:pb-0'>
