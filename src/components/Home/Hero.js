    ...
    return (
        <>
            <div className="w-full max-h-screen lg:min-h-screen relative">
                ...
                <img src={rocket} alt="Rocket" className="vector-graphics hidden lg;inline md:inline absolute bottom-0 right-0 left-0 " style={{ margin: "0 auto" }} />

                <div className="flex flex-col justify-center items-center gap-6 py-10">
                    <h1 className='text-5xl font-bold text-center'> Good coaching is good teaching </h1>
                    <p className='text-center font-bold opacity-70'>In a coaching role, you ask the questions and rely more on your staff, who become the <br /> experts, to provide the information.</p>
                </div>
